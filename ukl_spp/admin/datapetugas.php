...
<nav>
  ...
  <?php
        include "koneksi.php";
       $his=mysqli_query($conn, "select * from petugas where level like 'petugas' order by nama_petugas asc");
...
while($histori = mysqli_fetch_array($his)){
    ...
    $ubah="<td>"."<a href='ubah_petugas.php?id_petugas=".$histori['id_petugas']."' onclick='return confirm(Apakah anda yakin menghapus data ini?)' class='button-ubah'>Ubah</a>"."</td>";
