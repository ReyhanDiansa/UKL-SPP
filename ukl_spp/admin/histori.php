...
<nav>
  ...
  <?php
        include "koneksi.php";
       $his=mysqli_query($conn, "select p.*, t.nama_petugas from pembayaran p join petugas t on t.id_petugas=p.id_petugas join siswa s on s.NISN=p.NISN  order by id_pembayaran desc");
...
while($histori = mysqli_fetch_array($his)){
    $no++;
    $hapus="<td>"."<a href='hapus.php?id_pembayaran=".$histori['p.id_pembayaran']."' onclick='return confirm(Apakah anda yakin menghapus data ini?)' class='button-hapus'>Hapus</a>"."</td>";
    $ubah="<td>"."<a href='ubah_kelas.php?id_pembayaran=".$histori['p.id_pembayaran']."' onclick='return confirm(Apakah anda yakin menghapus data ini?)' class='button-ubah'>Ubah</a>"."</td>";
...
?>
                          <tr>
                            <td><?=$no?></td>
                            <td><?=$histori['t.nama_petugas']?></td>
                            <td><?=$histori['s.NISN']?></td>
                            <td><?=$histori['p.tgl_bayar']?></td>
                            <td><?=$histori['p.bulan_spp']?></td>
                            <td><?=$histori['p.tahun_spp'].$ubah.$hapus?></td>
                          </tr>
