...
<nav>
  ...
  <?php
        include "koneksi.php";
       $his=mysqli_query($conn, "select * from kelas  order by nama_kelas asc");
...
while($histori = mysqli_fetch_array($his)){
    ...
    $ubah="<td>"."<a href='ubah_kelas.php?id_kelas=".$histori['id_kelas']."' onclick='return confirm(Apakah anda yakin menghapus data ini?)' class='button-ubah'>Ubah</a>"."</td>";
...
?>
                          <tr>
                            ...
                            <td><?=$histori['angkatan'].$ubah.$hapus?></td>
                          </tr>
