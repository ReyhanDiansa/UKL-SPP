...
<nav>
  ...
  <?php
        include "koneksi.php";
       $his=mysqli_query($conn, "select * from spp ");
...
while($histori = mysqli_fetch_array($his)){
    ...
    $ubah="<td>"."<a href='ubah_spp.php?id_spp=".$histori['id_spp']."' onclick='return confirm(Apakah anda yakin menghapus data ini?)' class='button-ubah'>Ubah</a>"."</td>";
